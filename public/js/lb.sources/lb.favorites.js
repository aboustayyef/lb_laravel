  ...
  $.ajax({
    ...
    success: function(){
      ...
      $("li[data-blogid='" + $this.data('blogid') + "']").each(function(){
        $(this).removeClass('addToFavorites').addClass('removeFromFavorites').html('<i class="fa fa-star"></i>Remove it from your favorites</li>');
      });
...
$(document).on('click', 'li.removeFromFavorites', function(){
  ...
  $.ajax({
    ...
    success: function(){
      ...
      $("li[data-blogid='" + $this.data('blogid') + "']").each(function(){
        $(this).removeClass('removeFromFavorites').addClass('addToFavorites').html('<i class="fa fa-star"></i>Add it to your favorites</li>');
      });
