<?php namespace LebaneseBlogs\Crawling\News ;
  ...
  /**
   * Provides a list of providers and their characteristics
   * used to extract NewsProvider object
   *
   */

  class NewsProvidersDictionary
  {
    ...
    public function all(){
      ...
      'scraping'=>array(
        ...
        'canonical' => 'div.OUTBRAIN', // In case the canonical URL is different than the stated URL, dig for it in this Node
        'canonicalAttribute' => 'data-src', // The reference to the canonical URL can be through a data attribute
